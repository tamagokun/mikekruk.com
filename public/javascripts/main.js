/*
Written by Mike Kruk, http://mikekruk.com

A small collection of methods to allow Flash to have access
to a clean DOM for provide data in a way that makes sense,
is easy to update, and is SEO friendly. Yay!
...
var Stellar = function() {
	...
	this.init = function() {
		_data = document.getElementById(content);
	}
	
	this.hideContent = function() {
		_data.style.height = "0";
		_data.style.position = "absolute";
		_data.style.left = "-1000em";
		_data.style.overflow = "hidden";
		_data.style.visibility = "hidden";
	}
	
	this.showContent = function() {
		_data.setAttribute("style","");
	}
	
	this.getCodeBlock = function(id) {
		flashRef().focus();
		flashRef().setData(innerXHTML(document.getElementById(id)));
	}
	
	this.flashRef = function () {
